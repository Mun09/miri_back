...
class AdversarialDebate:
    ...
    {{
        "위험도": "안전 | 주의 | 위험",
        "정확도": 0 ~ 100,
        "평가내용": "전체적인 평가 요약.\\n\\n1. 시나리오 분석: 시니오의 핵심 내용을 한 줄로 요약.\\n2. 주요 위법 요소: 구체적으로 어떤 행위가 어떤 법령 조항에 저촉될 위험이 있는지 서술.\\n3. 종합 결론: 규제 샌드박스가 필요한지, 즉시 사업이 가능한지에 대한 최종 판단.\\n\\n⚠️ 중요: 각 항목(1, 2, 3) 사이에는 반드시 줄바꿈을 넣어서 가독성을 높일 것.",
        "인용근거": ["법령명 제O조", ...],
